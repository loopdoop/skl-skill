...
A Claude skill for driving the **skl** CLI — the npm-style tool for publishing,
installing, and managing AI-agent skills across harnesses (Claude, Codex,
Copilot, Cursor, Gemini, Grok).
